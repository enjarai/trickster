...
While [Spell Constructs](^trickster:items/spell_construct) partially alleviate these issues,
they are bulky and immobile, providing rather limited flexibility.

;;;;;

Fortunately, it seems that the [Torment Spell Core](^trickster:items/spawner_spell_core)'s 
