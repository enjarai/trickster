...
import dev.enjarai.trickster.spell.fragment.slot.FluidTypeFragment;
...
public class FragmentType<T extends Fragment> implements RetType<T>, ArgType<T> {
    ...
    public static final FragmentType<FluidTypeFragment> FLUID_TYPE = register("fluid_type", FluidTypeFragment.ENDEC, 0x132ea8);
