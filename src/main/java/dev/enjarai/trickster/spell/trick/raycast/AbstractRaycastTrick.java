...
public abstract class AbstractRaycastTrick<T extends Fragment> extends Trick<AbstractRaycastTrick<T>> {
    ...
    public abstract Optional<T> run(SpellContext ctx, Optional<Entity> entity, Vec3d position, Vec3d direction, Optional<BooleanFragment> bool) throws BlunderException;
}
