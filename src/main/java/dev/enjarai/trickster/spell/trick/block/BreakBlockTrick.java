...
public class BreakBlockTrick extends Trick<BreakBlockTrick> {
    public BreakBlockTrick() {
        super(Pattern.of(1, 5, 8, 6, 4, 1, 0, 3, 6), Signature.of(FragmentType.VECTOR, BreakBlockTrick::breakBlock));
    }

    public Fragment breakBlock(SpellContext ctx, VectorFragment pos) throws BlunderException {
