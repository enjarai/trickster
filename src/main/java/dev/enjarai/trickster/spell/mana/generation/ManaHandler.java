...
public interface ManaHandler {
    ...
    StructEndec<ManaHandler> ENDEC = EndecTomfoolery.lazyStruct(() -> (StructEndec<ManaHandler>) Endec.dispatchedStruct(ManaHandlerType::endec, ManaHandler::type, MinecraftEndecs.ofRegistry(ManaHandlerType.REGISTRY)));
