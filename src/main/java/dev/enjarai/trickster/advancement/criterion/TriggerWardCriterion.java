...
public class TriggerWardCriterion extends AbstractCriterion<TriggerWardCriterion.Conditions> {
    @Override
    public Codec<TriggerWardCriterion.Conditions> getConditionsCodec() {
        return TriggerWardCriterion.Conditions.CODEC;
    }
