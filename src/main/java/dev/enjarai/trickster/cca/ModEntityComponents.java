...
public class ModEntityComponents implements EntityComponentInitializer {
    ...
    public static final ComponentKey<IsEditingScrollComponent> IS_EDITING_SCROLL = ComponentRegistry.getOrCreate(
            Trickster.id("is_editing_scroll"),
    ...
    public static final ComponentKey<PlayerAnimationComponent> PLAYER_ANIMATION = ComponentRegistry.getOrCreate(
            Trickster.id("player_animation"),
