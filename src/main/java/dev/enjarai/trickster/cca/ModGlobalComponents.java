...
public class ModGlobalComponents implements ScoreboardComponentInitializer {
    ...
    public static final ComponentKey<MessageHandlerComponent> MESSAGE_HANDLER =
            ComponentRegistry.getOrCreate(Trickster.id("message_handler"), MessageHandlerComponent.class);
