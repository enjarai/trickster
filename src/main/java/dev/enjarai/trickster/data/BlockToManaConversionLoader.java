...
public class BlockToManaConversionLoader extends CompleteJsonDataLoader implements IdentifiableResourceReloadListener {
    ...
    public BlockToManaConversionLoader(RegistryWrapper.WrapperLookup registryLookup) {
        ...
        super(GSON/*Replaceable.CODEC*/, "conversion/block_to_mana");
        this.registryLookup = registryLookup;
    }

    @Override
    public Identifier getFabricId() {
        return Trickster.id("conversion", "block_to_mana");
    }
    ...
    public Optional<Float> convert(BlockState state) {
        ...
        ruleLoop: for (ConversionRule rule : rules) {
    ...
    public record Replaceable(boolean replace, List<ConversionRule> conversions) {
        public static final Function<Block, Codec<Replaceable>> CODEC = Util.memoize(block ->
          RecordCodecBuilder.create(instance ->
            instance.group(
              Codec.BOOL.optionalFieldOf("replace", false).forGetter(Replaceable::replace),
              ConversionRule.CODEC.apply(block).listOf().fieldOf("consume").forGetter(Replaceable::conversions)
