...
public class CircleSoupWidget extends StatefulWidget {
    ...
    public static class State extends WidgetState<CircleSoupWidget> {
                    ...
                    new Builder(context1 -> {
                        ...
                        return new MouseArea(
                            area -> area
                                ...
                                .dragStartCallback(startDragging(state))
        ...
        private MouseArea.DragStartCallback startDragging(CircleSoupState state) {
            return (button, modifiers) -> state.dragging = true;
        }
        ...
        private void drag(double x, double y, double deltaX, double deltaY) {
        ...
        class CircleState {
            ...
            private void fork() {
                List.copyOf(childCircles).forEach(CircleState::discard);
                childCircles.clear();
            ...
            public void updatePattern(Pattern pattern) {
                ...
                //                if (rev.isPresent()) {
                //                    var result = rev.get().apply(revisionContext, part, drawingPart);
                //
                //                    if (result != spellPart) {
                //                        if (!parents.isEmpty()) {
                ...
                //                } else {
                setState(() -> {
                    partView.part.glyph = new PatternGlyph(pattern);
                });
                //                }
            }
