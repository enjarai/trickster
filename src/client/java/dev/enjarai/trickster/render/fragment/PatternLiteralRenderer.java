...
public class PatternLiteralRenderer implements FragmentRenderer<Pattern> {
    ...
    @Override
    public void render(
        Pattern fragment, MatrixStack matrices, VertexConsumerProvider vertexConsumers,
        float x, float y, float size, float alpha, Vec3d normal, float tickDelta,
    ...
    @Override
    public float get_proportional_height(Pattern fragment) {
        return 0;
    }
